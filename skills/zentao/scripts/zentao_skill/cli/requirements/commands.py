...
from ...services.requirements.service import RequirementsService
...
def register(resource_subparsers: argparse._SubParsersAction[argparse.ArgumentParser]) -> None:
    p_create = resource_subparsers.add_parser('create', help='创建用户需求')
    ...
    p_edit = resource_subparsers.add_parser('edit', help='修改用户需求')
    ...
    p_list = resource_subparsers.add_parser('list', help='获取产品用户需求列表')
    ...
    p_view = resource_subparsers.add_parser('view', help='获取用户需求详情')
    ...
    p_activate = resource_subparsers.add_parser('activate', help='激活用户需求')
    ...
    p_delete = resource_subparsers.add_parser('delete', help='删除用户需求')
