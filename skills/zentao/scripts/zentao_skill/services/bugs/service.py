...
class BugsService:
    ...
    def edit(self, *, item_id: int, affected_build: list[object] | None = None, execution: object | None = None, priority: object | None = None, project: object | None = None, severity: object | None = None, steps: object | None = None, story: object | None = None, title: object | None = None, type: object | None = None) -> object | None:
        if title is None and severity is None and priority is None and type is None and affected_build is None and steps is None and project is None and execution is None and story is None:
            raise UsageError("edit 至少需要提供一个修改字段")
        return self.api.edit(item_id=item_id, title=title, severity=severity, priority=priority, type=type, affected_build=affected_build, steps=steps, project=project, execution=execution, story=story)
