...
class RequirementsService:
    ENDPOINT_IDS = RequirementsAPI.ENDPOINT_IDS

    def __init__(self, api: RequirementsAPI) -> None:
        self.api = api
    ...
    def edit(self, *, item_id: int, title: object | None, assignee: object | None = None, category: object | None = None, estimate: object | None = None, module: object | None = None, parent: object | None = None, priority: object | None = None, source: object | None = None) -> object | None:
        return self.api.edit(item_id=item_id, title=title, priority=priority, module=module, parent=parent, estimate=estimate, category=category, source=source, assignee=assignee)
    ...
    def change(self, *, item_id: int, reviewer: list[object] | None, spec: object | None = None, title: object | None = None, verify: object | None = None) -> object | None:
        return self.api.change(item_id=item_id, reviewer=reviewer, title=title, spec=spec, verify=verify)
