...
ROUTES = [
    Route('product-plan.create', 'POST', '/api.php/v2/productplans', 'product-plan', 'create', required_query=(), required_body=('productID', 'title'), enum_values=()),
    Route('product-plan.edit', 'PUT', '/api.php/v2/productplans/{planID}', 'product-plan', 'edit', required_query=(), required_body=('title',), enum_values=()),
