...
ROUTES = [
    ...
    Route('bug.list_product', 'GET', '/api.php/v2/products/{productID}/bugs', 'bug', 'list_product', required_query=(), required_body=(), enum_values=(('browseType', ('all', 'longlifebugs', 'postponedbyme', 'resolvedbyme', 'toclosed', 'unclosed', 'unconfirmed', 'unresolved')),)),
    Route('bug.list_project', 'GET', '/api.php/v2/projects/{projectID}/bugs', 'bug', 'list_project', required_query=(), required_body=(), enum_values=(('browseType', ('all', 'longlifebugs', 'postponedbyme', 'toclosed', 'unclosed', 'unconfirmed', 'unresolved')),)),
    Route('bug.list_execution', 'GET', '/api.php/v2/executions/{executionID}/bugs', 'bug', 'list_execution', required_query=(), required_body=(), enum_values=(('browseType', ('all', 'longlifebugs', 'postponedbyme', 'toclosed', 'unclosed', 'unconfirmed', 'unresolved')),)),
