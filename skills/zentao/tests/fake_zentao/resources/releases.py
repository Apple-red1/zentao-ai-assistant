...
ROUTES = [
    ...
    Route('release.edit', 'PUT', '/api.php/v2/releases/{releaseID}', 'release', 'edit', required_query=(), required_body=('system', 'name', 'build', 'date'), enum_values=(('status', ('fail', 'normal', 'terminate', 'wait')),)),
